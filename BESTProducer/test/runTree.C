...
for (int i = 0; i < origFiles->GetEntries(); i++){
   ...
   float NNout1 = (reader->EvaluateRegression( "MLP method" ))[3];
   float NNout2 = (reader->EvaluateRegression( "MLP method" ))[3];
   float NNout3 = (reader->EvaluateRegression( "MLP method" ))[3];
   float NNout4 = (reader->EvaluateRegression( "MLP method" ))[3];
